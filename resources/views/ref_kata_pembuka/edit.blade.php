...
<div class="row">
    <div class="col-md-12">
        <h2>Edit Kata Pembuka</h2>
        <div class="card">
            <div class="card-body">

                <form class="form-horizontal auth-form my-4"
                    action="{{ route('ref_kata_pembuka.update', ['id' => Crypt::encryptString($kataPembuka->id)]) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-single form-control @error('kategori') is-invalid @enderror" id="kategori"  name="kategori" required>
                            ...
                            <option value="{{ $item->id }}" {{ ($kataPembuka->kategori == $item->id) ? 'selected' : '' }}>{{ $item->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input id="kata_pembuka"  type="text" name="kata_pembuka" class="form-control @error('kata_pembuka') is-invalid @enderror" placeholder="Masukkan Kata Pembuka" value="{{ $kataPembuka->kata_pembuka }}">
